  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "InsightForge AI — AI Analytics for Every Dataset" },
      {
        ...
        content:
          "Turn any CSV or spreadsheet into a live dashboard with AI-generated insights, forecasts, and a chat analyst.",
      },
...
function RootComponent() {
  ...
  useEffect(() => registerStaleChunkRecovery(), []);
